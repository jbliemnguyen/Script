...
New-SBFarm -SBFarmDBConnectionString 'Data Source=SPSQL;Initial Catalog=SPPROD_SB_Management;Integrated Security=True;Encrypt=False' `
-InternalPortRangeStart 9000 -TcpPort 9354 -MessageBrokerPort 9356 -RunAsAccount 'ADFERC\svc.spservice.prod' -AdminGroup 'BUILTIN\Administrators' `
-GatewayDBConnectionString 'Data Source=SPSQL;Initial Catalog=SPPROD_SB_Gateway;Integrated Security=True;Encrypt=False' `
-CertificateAutoGenerationKey $SBCertificateAutoGenerationKey -MessageContainerDBConnectionString `
'Data Source=SPSQL;Initial Catalog=SPPROD_SB_MessageContainer;Integrated Security=True;Encrypt=False' -Verbose;
...
New-WFFarm -WFFarmDBConnectionString 'Data Source=SPSQL;Initial Catalog=SPPROD_WFM_Management;Integrated Security=True;Encrypt=False' `
-RunAsAccount 'ADFERC\svc.spservice.prod' -AdminGroup 'BUILTIN\Administrators' -HttpsPort 12290 -HttpPort 12291 -InstanceDBConnectionString `
'Data Source=SPSQL;Initial Catalog=SPPROD_WFM_InstanceManagement;Integrated Security=True;Encrypt=False' -ResourceDBConnectionString `
'Data Source=SPSQL;Initial Catalog=SPPROD_WFM_ResourceManagement;Integrated Security=True;Encrypt=False' -CertificateAutoGenerationKey `
